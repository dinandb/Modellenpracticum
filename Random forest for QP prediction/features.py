...
from extras import load_processed_data, save_processed_data, get_only_extrema_vals, get_only_extrema_vals_vector, get_only_max_vals_vector
...
def init(to_log=True, extrema=True):
    ...
    base_saved_data_path = Path("pickle_saves/data")
    ...
    data3_data_path = base_path_data / "5415M_Hs=3m_Tp=10s_10h.csv"
    data3_saved_path = base_saved_data_path / "data3.pkl"
    
    data4_data_path = base_path_data / "5415M_Hs=4m_Tp=10s_10h.csv"
    data4_saved_path = base_saved_data_path / "data4.pkl"

    data5_data_path = base_path_data / "5415M_Hs=5m_Tp=10s_10h.csv"
    ...
    if extrema:
        Xs, ys = all_features(data1, None, data3, data4, data5, y, None, y3, y4, y5, start_index1, stop_index1, None, None, start_index3, stop_index3, start_index4, stop_index4, start_index5, stop_index5)
        return Xs, ys
...
def main():
    Xs, ys = init(to_log=False, extrema=True)
