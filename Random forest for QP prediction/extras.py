...
def get_only_max_vals_vector(data, colname, new=False, name="0"):
    ...
    try:
        ...
        maxes, indices = load_processed_data(f"pickle_saves/vectors/{name}.pkl")
        ...
        save_processed_data((maxes, indices), f"pickle_saves/vectors/{name}.pkl")
...
def get_only_extrema_vals(data, colname="z_wf", name="0", new = False):
    ...
    try:
        ...
        extrema = load_processed_data(f"pickle_saves/vectors/{name}.pkl")
        ...
        save_processed_data(extrema, f"pickle_saves/vectors/{name}.pkl")
