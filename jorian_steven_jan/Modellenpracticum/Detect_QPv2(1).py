...
timeThres = 30
HRThres = 0.5
rollThres = sc.special.radian(1.5,0,0)
pitchThres = sc.special.radian(1.5,0,0)
inclThres = sc.special.radian(2.0,0,0)
...
#df.to_csv (r"C:\Users\steve\OneDrive\Bureaublad\VS Code\Modellenpracticum\Data4_added.csv", index = False, header=True) 
...
#QP_start_data.to_csv (r"C:\Users\steve\OneDrive\Bureaublad\VS Code\Modellenpracticum\Data4_QPstarts.csv", index = False, header=True) 
