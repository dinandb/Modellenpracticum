...
for layer in range(1, 4):    
    for hidden_size in hidden_sizes:
        data = data_prep3(df, 'z_velocity', max_lookback, 1.0, max_prediction, max_lookback)    
        ...
        for epoch in range(num_epochs):
            ...
            if max_average <= average and epoch > 15:
                max_average = average
                max_acc = Acc
                max_RFPR = RFPR
                m_epoch = epoch
        ...
        print(layer, hidden_size, "&", max_acc, "&", max_F1, "&", max_RFPR, "&", max_average, "&", m_epoch)
